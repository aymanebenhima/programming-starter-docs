...
<div style="text-align: center; margin-top: 2rem;">
  <h2>What is YouCode?</h2>
  <p style="font-size: 1.2rem; color: #555; max-width: 800px; margin: 0 auto; line-height: 1.8;">
    <strong>YouCode</strong> is an inclusive programming school that emphasizes a peer-to-peer, project-based learning methodology. Designed to make tech education accessible, YouCode empowers individuals by turning them into highly skilled developers ready for the modern digital workforce. The pedagogy relies heavily on collaboration, self-directed learning, and real-world problem-solving.
  </p>
</div>
